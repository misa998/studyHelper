...
public class Controller {
    ...
    public void addCourse() throws IOException {
        GridPane gridPane = FXMLLoader.load(getClass().getResource("editPaneView.fxml"));
    ...
    public void dashboardTabChanged(){
        ...
        for(int i=0; i<courses.length; i++){
            ...
            for(int j=0; j<daysToShow; j++) {
                ...
                List<TimePerDay> timePerDayForDayAndCourseId = DataSource.getInstance().getTimePerDayForDayAndCourseId(courses[i].getId(), localDate);
